def get_model(model_name, args):
    ...
    elif name == "simplecil_withexamplar":
        from models.simplecil_withexamplar import SimPlecil_withExamplar
        return SimPlecil_withExamplar(args)
    elif name == "crosstest":
        from models.crosstest import CrossTest
        return CrossTest(args)
    elif name == "oursmethod":
        from models.oursmethod import OursMethod
        return OursMethod(args)
    elif name == "dgr":
