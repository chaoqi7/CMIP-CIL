...
parser.add_argument('--data_dir', default="/root/autodl-tmp/DataSet/ScanObjectNN_9.7GB/",  help='path to 3D dataset')
...
parser.add_argument('--nb_views', default=10, type=int,
